  ...
  return (
    <div className="max-w-[1200px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        <a href="" className="relative rounded-[6px] overflow-hidden">
      ...
      <div className="pt-1 bg-text-gradient self-stretch rounded-lg rounded-b-xl mt-8">
        <div className="bg-[#2A2634] px-8 py-6 rounded-md rounded-b-lg flex justify-between items-center">
          <div>
